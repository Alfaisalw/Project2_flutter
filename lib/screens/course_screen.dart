                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Text(
                              course.isOpen == false ? "مغلق" : "متاح التسجيل",
                              style: TextStyle(
                                color: course.isOpen == true
                                    ? Colors.greenAccent
                                    : Colors.redAccent,
                                fontSize: 10,
                        ...
                        Text(
                          course.title!,
                          style: TextStyle(
                            color: const Color.fromARGB(218, 255, 253, 253),
                            fontSize: 15,
                          ),
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis,
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text("ابـــدأ", style: TextStyle(fontSize: 22)),
                              ],
                            ),
                          ),
                        ),
